...
func TestOpen(t *testing.T) {
	...
	baseDevice.output = concat(output1, spacer, output2, spacer)
	expectedInput := concatInto(make([]byte, 65), []byte{0, 0xff, 0xff, 0xff, 0xff, 0x86, 0, 8, 1, 2, 3, 4, 5, 6, 7, 8})
...
func TestSendAPDU(t *testing.T) {
	baseDevice := &testWrapperDevice{}
	dev := newHidDevice(baseDevice)
	baseDevice.output = concatInto(make([]byte, 64), []byte{255, 255, 255, 255, 0x83, 0, 8, 85, 50, 70, 95, 86, 50, 0x90, 0x00})
	expectedInput := concatInto(make([]byte, 65), []byte{0, 255, 255, 255, 255, 0x83, 0, 12, 0, 0x03, 0, 0, 0, 0, 0x03, 1, 2, 3, 0x04, 0})
...
func TestSendRequestShortValue(t *testing.T) {
	...
	expectedFull := concatInto(make([]byte, 65), expectedSub)
...
func TestSendRequestLongValue(t *testing.T) {
	...
	expected := concatInto(make([]byte, 65*5), header1, data1, header2, data2, header3, data2, header4, data2, header5, data3)
	requestData := concat(data1, data2, data2, data2, data3)
...
func TestReadResponseError(t *testing.T) {
	...
	response := concatInto(make([]byte, 64), subResponse)
...
func TestReadResponseShortValue(t *testing.T) {
	...
	output := concatInto(make([]byte, 64), expected)
...
func TestReadResponseLongValue(t *testing.T) {
	...
	expected := concat(data1, data2, data2, data2, data3)
	output := concatInto(make([]byte, 64*5), header1, data1, header2, data2, header3, data2, header4, data2, header5, data3)
	dev := &testWrapperDevice{output: output}
